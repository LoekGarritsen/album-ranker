  ...
  <ModalDialog max-width="max-w-sm" @close="emit('close')">
    ...
    <div class="flex gap-3">
      ...
      <button
        ...
        @click="emit('confirm')"
        :disabled="busy"
        class="flex-1 px-4 py-2 bg-red-500 text-white font-medium rounded-xl hover:bg-red-600 transition-colors disabled:opacity-50 flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400"
      >
