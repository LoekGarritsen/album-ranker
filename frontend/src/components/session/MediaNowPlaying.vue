    ...
    <div v-if="!media" class="p-6 text-center">
      ...
      <div class="flex items-center justify-center gap-2">
        ...
        <button
          @click="emit('sync')"
          :disabled="isSyncing"
          class="p-2.5 rounded-full hover:bg-surface-highlight transition-colors text-text-subdued"
      ...
      <div class="p-4">
        <div class="flex items-center gap-3 mb-3">
          ...
          <button
            ...
            @click="emit('sync')"
            :disabled="isSyncing"
            class="p-2.5 rounded-full hover:bg-surface-highlight transition-colors flex-shrink-0 text-text-subdued"
            :class="{ 'animate-spin': isSyncing }"
          ...
          <button
            @click="emit('favorite')"
            class="p-2.5 rounded-full hover:bg-surface-highlight transition-colors flex-shrink-0"
          ...
          <button
            @click="emit('toggle')"
            class="p-3 bg-white text-black rounded-full hover:scale-[1.06] transition-transform flex-shrink-0"
        ...
        <div class="flex items-center gap-2 mb-3">
          <button
            ...
            :class="myVote === 1 ? 'bg-green-400/15 text-green-400' : 'bg-surface-highlight text-text-subdued hover:text-green-400 hover:bg-surface-elevated'"
          ...
          <button
            ...
            class="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm transition-colors min-h-[36px]"
            :class="myVote === -1 ? 'bg-red-400/15 text-red-400' : 'bg-surface-highlight text-text-subdued hover:text-red-400 hover:bg-surface-elevated'"
